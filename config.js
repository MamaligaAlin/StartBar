...
const CONFIG = {
	...
	// Weather
	weatherKey: '27f030b5957205f3a9b6e7336948db6f', // Write here your API Key
	weatherIcons: 'OneDark', // 'Onedark', 'Nord', 'Dark', 'White'
	weatherUnit: 'C', // 'F', 'C'
	language: 'en', // More languages in https://openweathermap.org/current#multi

	trackLocation: true, // If false or an error occurs, the app will use the lat/lon below
	defaultLatitude: '47.1584',
	defaultLongitude: '27.6014',
	...
	firstlistsContainer: [
		...
		},
		{
			...
			links: [
				...
				{
					name: 'WebMail',
					link: 'https://mail.info.uaic.ro/?_task=mail&_mbox=INBOX',
				},
			],
		},
	],
